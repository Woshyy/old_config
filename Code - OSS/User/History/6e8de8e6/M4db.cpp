...
void skrivInfo() {
    cout << "Programmet kommer att be om två siffor och en operation där den kommer att returnera resultatet när operationen är utförd på alla tal mellan de angivna siffrorna och de angivna siffrorna." << endl;
