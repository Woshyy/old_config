...
//*********************************************************************************
char lasOp() {
    cout << "a = addera" << endl << "m = multiplicera" << endl << "k = kvadratsumman" << endl;
    while (true) {
        ...
        cout << "Det där var inte ett operation som är implementerad! Vänligen mata in ett operation som är giltig."
    }
    return c;
}
