...
group.add_argument(
    "IDKbot", help="The name of the bot to register", action="store")
parser.add_argument(
    "chrwa634@student.liu.se", help="The email of the bot to register", action="store")
parser.add_argument(
    "Lisalisa55", help="The password of the bot to register", action="store")
parser.add_argument(
    "liu", help="The team of the bot to register", action="store")
