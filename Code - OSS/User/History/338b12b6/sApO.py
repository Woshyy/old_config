...
group.add_argument(
    "--name", help="IDKbot", action="store")
parser.add_argument(
    "--email", help="chrwa634@student.liu.se", action="store")
parser.add_argument(
    "--password", help="Lisalisa55", action="store")
parser.add_argument(
    "--team", help="liu", action="store")
parser.add_argument("--board", help="1", action="store")
parser.add_argument(
    "--time-factor",
