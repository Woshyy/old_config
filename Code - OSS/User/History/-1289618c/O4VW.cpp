...
// Syfte: Funktionen beräknar antalet karaktärer som förekommmer i den givna strängen. Resultatet sparas
//        i ett given array of storleken ANTAL_BOKSTAVER där index 0 representerar A och index 1 respresenterar B.
// Inparametrar: text - strängen som karaktärmängden kommer att beräknas.
//               number_of_characters - är den andra talgränsen
...
// och index 1 innehåller antalet B som förekommer. Jag itererar över alla karaktärer i strängen och omvandla de till versaler.